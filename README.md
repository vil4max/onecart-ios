...
OneCart — нативное SwiftUI-приложение для общих семейных покупок. Вход выполняется через **Sign in with Apple**; данные хранятся локально в Core Data и синхронизируются через iCloud/CloudKit.
