...
Local release candidate: **1.3.0 (1)** for both the app and widget extension.
...
Release notes and candidate status: [1.3.0](releases/1.3.0.md) (previous: [1.2.1](releases/1.2.1.md)).
