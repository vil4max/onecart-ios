...
**REQ-SIRI-020** «Что осталось в OneCart» reads the to-buy names in the order the cart screen shows them (its category sections, REQ-SHELL-010), at most five followed by how many more remain, or says that the cart is empty or everything is bought. It never changes the cart.
