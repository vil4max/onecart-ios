...
| Version in repo | `MARKETING_VERSION` 1.5.0, build 1 (1.3.0 was hidden in TestFlight behind an older 1.4 record — [releases/1.5.0.md](../operations/releases/1.5.0.md)) (Xcode Cloud assigns uploaded build numbers) |
