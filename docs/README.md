...
|-----|----------|----------|
| [architecture.md](architecture.md) | agents / contributors | MVVM layout, owner files, Core Data + CloudKit stores, three-tab shell |
...
**Working agreement:** ship a reliable SIWA → one living cart → add/check → invite/sync loop before restoring Stores/catalog/price UX. Details in [product.md](product.md).
