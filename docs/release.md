...
Version: **1.2 (23)** — bump `CURRENT_PROJECT_VERSION` again before each new upload to ASC for the same marketing version.
...
1. Signed Debug build on A and B (version 1.2 / build ≥ 23).
