    ...
    private static let rules: [Rule] = [
        Rule(
            ...
            media: OfficialProductMedia(
                imageURL: URL(string: "https://src.zakaz.atbmarket.com/cache/photos/18797/catalog_product_gal_mob_18797.jpg")!,
        ...
        Rule(
            ...
            storeAliases: ["атб", "atb"],
            media: OfficialProductMedia(
                imageURL: URL(string: "https://src.zakaz.atbmarket.com/cache/photos/31637/catalog_product_gal_mob_31637.jpg")!,
        ...
        Rule(
            ...
            media: OfficialProductMedia(
                imageURL: URL(string: "https://images.silpo.ua/v2/products/744x744/webp/f823d548-8855-41ec-973c-ec846b395477.png")!,
                sourceURL: URL(string: "https://silpo.ua/product/moloko-ultrapasteryzovane-na-zdorov-ia-bezlaktozne-2-5-857563")!,
                sourceName: "Сільпо"
            )
        ),
        Rule(
            ...
            storeAliases: ["сільпо", "сильпо", "silpo"],
            media: OfficialProductMedia(
                imageURL: URL(string: "https://images.silpo.ua/v2/products/744x744/webp/f48ceed7-015a-415b-a340-d1101d998261.png")!,
        ...
        Rule(
            ...
            storeAliases: ["сільпо", "сильпо", "silpo"],
            media: OfficialProductMedia(
                imageURL: URL(string: "https://images.silpo.ua/v2/products/744x744/webp/b750bc2a-fde6-4d89-b703-939588c84c94.png")!,
                sourceURL: URL(string: "https://silpo.ua/product/syr-gouda-napivtverdyi-z-korov-iachogo-moloka-narizanyi-skybkamy-48-1009450")!,
                sourceName: "Сільпо"
            )
        ),
        Rule(
            ...
            media: OfficialProductMedia(
                imageURL: URL(string: "https://img3.zakaz.ua/89b4d9093f374877b5099687d2bf590f/1756745262-s350x350.jpg")!,
