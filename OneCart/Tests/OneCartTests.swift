...
final class OneCartTests: XCTestCase {
    ...
    func testCatalogProductQualityRejectsFilesBadPricesAndFoodOnHousehold() throws {
        ...
        XCTAssertEqual(
            OfficialCatalogProductQuality
                .cleanTitle("Перець солодкий червоний купити в Києві та Україні за ціною від 99.95 грн ★ АТБ Маркет"),
        ...
        let deepPromo = try XCTUnwrap(
            OfficialCatalogProductQuality.sanitizedPrices(
                price: 899,
                originalPrice: 2482.92,
                loyaltyPrice: nil
            )
        )
        XCTAssertEqual(deepPromo.originalPrice ?? 0, 2482.92, accuracy: 0.01)
        ...
        let upgraded = try OfficialCatalogProductQuality.upgradedImageURL(
            XCTUnwrap(
        ...
        let varusImage = try OfficialCatalogProductQuality.upgradedImageURL(
            XCTUnwrap(
    ...
    func testCatalogMergeDropsInvalidScrapedRows() throws {
        ...
        let absurdPrice = try OfficialCatalogProduct(
            name: "Ще один товар",
            price: 0.01,
            originalPrice: nil,
            imageURL: nil,
            sourceURL: XCTUnwrap(URL(string: "https://shop.example.com/products/bad-price")),
            storeName: "Магазин"
        )
    ...
    func testDiscountCollectionExcludesProductsWithoutConfirmedOldPrice() throws {
        let regular = try OfficialCatalogProduct(
            name: "Обычный товар",
            price: 40,
            originalPrice: nil,
            imageURL: nil,
            sourceURL: XCTUnwrap(URL(string: "https://shop.example.com/products/regular")),
            storeName: "Магазин"
        )
        let discounted = try OfficialCatalogProduct(
            name: "Акционный товар",
            price: 75,
            originalPrice: 100,
            imageURL: nil,
            sourceURL: XCTUnwrap(URL(string: "https://shop.example.com/products/discounted")),
            storeName: "Магазин"
        )
    ...
    func testOfficialCatalogMergeUpdatesPriceWithoutDuplicatingProduct() throws {
        ...
        let previous = try OfficialCatalogProduct(
            name: "Засіб для миття посуду",
            price: 99.99,
            originalPrice: nil,
            imageURL: imageURL,
            sourceURL: XCTUnwrap(URL(string: "https://shop.example.com/product/1?ref=old")),
            storeName: "Магазин",
        ...
        let refreshed = try OfficialCatalogProduct(
            name: "Засіб для миття посуду",
            price: 79.99,
            originalPrice: 109.99,
            imageURL: nil,
            sourceURL: XCTUnwrap(URL(string: "https://shop.example.com/product/1?ref=new")),
            storeName: "Магазин",
            details: OfficialCatalogProductDetails(
                summary: nil,
                ingredients: nil,
    ...
    func testExpiredPromotionIsNotPresentedAsDiscount() throws {
        ...
        let product = try OfficialCatalogProduct(
            name: "Акційний товар",
            price: 50,
            originalPrice: 100,
            imageURL: nil,
            sourceURL: XCTUnwrap(URL(string: "https://shop.example.com/product/expired")),
            storeName: "Магазин",
    ...
    func testFreshRegularPriceClearsPreviousPromotion() throws {
        ...
        let previous = OfficialCatalogProduct(
            ...
            sourceURL: sourceURL,
            storeName: "Магазин",
            promotionEndsAt: firstFetch.addingTimeInterval(3600),
    ...
    func testOfficialCatalogPriceAndDiscountSorting() throws {
        ...
        let regular = try OfficialCatalogProduct(
            ...
            originalPrice: nil,
            imageURL: nil,
            sourceURL: XCTUnwrap(URL(string: "https://shop.example.com/product/regular")),
            storeName: "Магазин"
        )
        let discounted = try OfficialCatalogProduct(
            ...
            originalPrice: 150,
            imageURL: nil,
            sourceURL: XCTUnwrap(URL(string: "https://shop.example.com/product/discount")),
            storeName: "Магазин"
        )
